...
INSERT INTO `employer` (`username`,  `password`, `Name`, `email`, `employer_id` `contact_no`, `address`, `gender`, `birthdate`, `company`, `profile_sum`) VALUES
('aaa', 'aaa', 'aaa', 'aaa', '111' 'aaa', 'aaa', 'aaa', '2018-06-07', 'aaa', 'aaa'),
('aaa1', 'aaa', 'aaa', 'aaa', '112', 'aaa' ,'aaa', 'aaa', '2018-06-07', 'aaa', 'aaa'),
('dddddd', '1dddddd', 'Ddd Dd', 'd@d', '113', '123456', 'dfd', 'female', '2222-11-11', 'qqq', 'qqq'),
('employer1', '111111', 'Employer One', 'e@e1', '114','123456', 'Raojan, Chittagong', 'male', '1999-11-11', 'Company1', 'This is a profile summery'),
('employer2', '111111', 'Employer Two', 'e@e2', '115','123456', 'Raojan, Chittagong', 'male', '1999-11-11', 'Company1', 'This is a profile summery'),
('employer3', '111111', 'Employer Three', 'e@e3','116', '123456', 'Raojan, Chittagong', 'male', '1999-11-11', 'Company1', 'This is a profile summery'),
('rrrupom', 'rrrupom', 'Rupom', 'rupom', 'rupom', '117','rupom', '', '2018-06-04', 'rupom', 'rupom');
...
CREATE TABLE `e_social` (
  ...
  `social_prof` varchar(200) NOT NULLS
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
